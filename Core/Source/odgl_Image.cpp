...
Image::Image() : _textureID(0),
                 _height(0),
                 _width(0)
{
}

Image::Image(const char *filepath) : _textureID(0),
                                     _height(0),
                                     _width(0)
{
...
GLuint Image::LoadBMPFromFile(const char *filepath)
{
    ...
    GL_CHECK(glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, _width, _height, 0, GL_RGB, GL_UNSIGNED_BYTE, data));
